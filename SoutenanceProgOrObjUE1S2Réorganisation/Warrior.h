...
public:
    ...
    Warrior(const std::string& name, int level, int health, int healthMax, const std::string& team, double expUp)
        : Character(name, "Warrior", level, health, healthMax, team, expUp, 0, 35)
    {
